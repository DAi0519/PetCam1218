/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce0cfab04267d88058853b8be38ac1b4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_KEY" | "ADMIN_SECRET">> {}
}
