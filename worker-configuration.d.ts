/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 11e8b9c8db08064ccc771970b6eed5cf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POE_API_KEY" | "ADMIN_SECRET">> {}
}
